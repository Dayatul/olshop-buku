<x-layout-front title="Transaksi - Wigati Buku">
    ...
    <section class="py-20 px-10 space-x-6 container mx-auto flex items-center justify-between ">
        <div class="container mx-auto w-3/6 text-center">
            <h4 class="text-4xl font-bold mb-4 text-gray-600">Detail Transaksi</h4>
            <p class="text-lg mb-8 text-gray-600"></p>
        </div>
    </section>
    ...
    - Telepon: {{ $product_transaction->phone_number }}%0A
    - Catatan: {{ $product_transaction->notes }}%0A
    - Produk:%0A
