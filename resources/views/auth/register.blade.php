...
<body>
    ...
    <div class="flex flex-col items-center px-6 py-10 h-screen">
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="text" name="name" id="fullname__"
                        style="background-image: url('assets/svgs/ic-profile.svg');"
                        class="form-input bg-[url('/public/assets/svgs/ic-profile.svg')]"
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="email" name="email" id="email__"
                        ...
                        class="form-input bg-[url('/public/assets/svgs/ic-email.svg')]"
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="password" name="password" id="password__"
                        style="background-image: url('/assets/svgs/ic-lock.svg');" class="form-input"
